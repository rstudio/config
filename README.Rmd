...
[![R build status](https://github.com/rstudio/config/workflows/R-CMD-check/badge.svg)](https://github.com/rstudio/config/actions)
[![Codecov test coverage](https://codecov.io/gh/rstudio/config/branch/master/graph/badge.svg)](https://codecov.io/gh/rstudio/config?branch=master)
<!-- badges: end -->
